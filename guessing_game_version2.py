...
def start_game(name, current_high_score):
    ...
    while player_guess != answer:
        ...
        try:
            ...
            # Error handling for number out of range
...
def play_game():
    ...
    while play_again.lower() == "y":
        ...
        try:
            ...
            # Error handling for input that is not "y" or "n"
            if play_again.lower() != "y" or play_again.lower() != "n":
                raise ValueError("You entered {}." .format(play_again))
        except ValueError as error:
            play_again = input("{} Enter 'Y' to play again or 'N' to finish  ".format(error))
    # Goodbye message
    print("Goodbye")
